                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="javascript:;" class="btn btn-blue" onclick="simpan()">Simpan</a>
...
@push('ajax')
	<script>
		...
		function tambah(id){
			$.ajax({
				type: 'GET',
				url: "{{url('Anggota/tambah')}}",
				data: "id="+id,
				success: function(msg){
					
					$('#modal-tambah').modal('show');
					$('#tampil_tambah').html(msg);
		...
		function hapus(){
            let text = "Apakah yakin akan menghapus data.";
